...
class ACANet(nn.Module):
    ...
    def __init__(self, n_class, pretrained=True, freeze_back=False):
        ...
        # Decoder
        self.conv_up3_0_aff = convrelu(256 + 512, 256, kernel_size=3, padding=1)
        self.conv_up3_0_obj = convrelu(256 + 512, 256, kernel_size=3, padding=1)
        self.conv_up3_0_hand = convrelu(256 + 512, 256, kernel_size=3, padding=1)
        self.conv_up3_1_aff = convrelu(256, 256, kernel_size=3, padding=1)
        self.conv_up3_1_obj = convrelu(256, 256, kernel_size=3, padding=1)
        self.conv_up3_1_hand = convrelu(256, 256, kernel_size=3, padding=1)

        self.conv_up2_0_aff = convrelu(128 + 256, 128, kernel_size=3, padding=1)
        self.conv_up2_0_obj = convrelu(128 + 256, 128, kernel_size=3, padding=1)
        self.conv_up2_0_hand = convrelu(128 + 256, 128, kernel_size=3, padding=1)
        self.conv_up2_1_aff = convrelu(128, 128, kernel_size=3, padding=1)
        self.conv_up2_1_obj = convrelu(128, 128, kernel_size=3, padding=1)
        self.conv_up2_1_hand = convrelu(128, 128, kernel_size=3, padding=1)

        self.conv_up1_0_aff = convrelu(64 + 128, 128, kernel_size=3, padding=1)
        self.conv_up1_0_obj = convrelu(64 + 128, 64, kernel_size=3, padding=1)
        self.conv_up1_0_hand = convrelu(64 + 128, 64, kernel_size=3, padding=1)
        self.conv_up1_1_aff = convrelu(128, 64, kernel_size=3, padding=1)
        self.conv_up1_1_obj = convrelu(64, 64, kernel_size=3, padding=1)
        self.conv_up1_1_hand = convrelu(64, 64, kernel_size=3, padding=1)
        self.conv_up1_2_aff = convrelu(64, 64, kernel_size=3, padding=1)

        self.conv_up0_0_aff = convrelu(64, 32, kernel_size=3, padding=1)
        self.conv_up0_0_obj = convrelu(64 + 64, 32, kernel_size=3, padding=1)
        self.conv_up0_0_hand = convrelu(64 + 64, 32, kernel_size=3, padding=1)
        self.conv_up0_1_aff = convrelu(32, 32, kernel_size=3, padding=1)
        self.conv_up0_1_obj = convrelu(32, 32, kernel_size=3, padding=1)
        self.conv_up0_1_hand = convrelu(32, 32, kernel_size=3, padding=1)

        self.conv_original_size_0_aff = convrelu(32, 16, kernel_size=3, padding=1)
        self.conv_original_size_0_obj = convrelu(32, 16, kernel_size=3, padding=1)
        self.conv_original_size_0_hand = convrelu(32, 16, kernel_size=3, padding=1)
        self.conv_original_size_1_aff = convrelu(16, 16, kernel_size=3, padding=1)
        self.conv_original_size_1_obj = convrelu(16, 16, kernel_size=3, padding=1)
        self.conv_original_size_1_hand = convrelu(16, 16, kernel_size=3, padding=1)

        self.conv_last_aff = nn.Conv2d(16, n_class, kernel_size=3, padding=1)
        self.conv_last_obj = nn.Conv2d(16, 1, kernel_size=3, padding=1)
        self.conv_last_hand = nn.Conv2d(16, 1, kernel_size=3, padding=1)

        self.projection_aff1 = nn.Conv2d(128, out_channels=128, kernel_size=1, padding=0)
        self.projection_aff2 = nn.Conv2d(128, out_channels=128, kernel_size=1, padding=0)
    ...
    def forward(self, input):
        ...
        return out_aff, out_obj, out_hand
