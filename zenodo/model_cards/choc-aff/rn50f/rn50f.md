...
ResNet50-FastFCN-PSP (RN50F) is an affordance segmentation model designed by [Hussain et al.,"FPHA-Afford: A domain-specific benchmark dataset for occluded object affordance estimation in human-object-robot interaction", *ICIP*, 2020](https://ieeexplore.ieee.org/document/9190733). In the following, the details of our re-implementation.
...
**Primary intended uses.** The primary intended users of this model are academic researchers, scholars, and practitioners working in the fields of computer vision and robotics. The primary intended uses of RN50F are:
...
**Quantitative Analyses.** Provided in the paper. RN50F achieves low generalisation to real images.
